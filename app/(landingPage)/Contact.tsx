  ...
  return (
    <div className="py-10 flex flex-col items-center gap-8 text-white bg-gradient-to-r from-dark to-primary/70">
      ...
      <div className="flex gap-2 w-full justify-center items-center">
        <Input className="w-full max-w-sm bg-gradient-to-br from-white/80 to-white/90 text-black border border-white/20 backdrop-blur-md placeholder:text-black/50" placeholder="Email" />
